...
RE-Container (Red Engine Container) is a minimal and portable dependency injection framework designed for our Unity, Godot and C# projects.

> ⚠️ See [PLUGINS.md](../RE-Container.Unity/Assets/RE-Container.Unity/Plugins/PLUGINS.md) for important information about updating this package.
...
So we decided to make our own. RE-Container has a similar API to VContainer but with a leaner feature set and better portability.
...
RE-Container is simple to get up and running
