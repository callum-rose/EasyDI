...
public class LifecycleHookTypeAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeInvocation(SyntaxNodeAnalysisContext context)
    {
        ...
        if (methodSymbol.ContainingType.ToDisplayString() != "REContainer.LifecycleHooks.IObjectRegistryExtensions")
        {
            return;
        }
        ...
        var lifecycleHookType = context.Compilation.GetTypeByMetadataName("REContainer.LifecycleHooks.ILifecycleHook");
