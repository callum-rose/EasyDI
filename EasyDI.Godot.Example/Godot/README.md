# EasyDI Godot Example Project

This example project demonstrates how to use the EasyDI plugin in Godot with C#, featuring a complete MVP (Model-View-Presenter) implementation with dependency injection across multiple lifetime scopes.

> **Note:** For plugin installation, setup instructions, and troubleshooting, see the [Plugin README](addons/EasyDI.Godot/README.md).
...
1. **Install NuGet Packages**
   - Ensure `EasyDI` and `EasyDI.LifecycleHooks` packages are restored
...
### Configuration
- **`EasyDI Settings.tres`** - Resource defining ApplicationScopePrefab and SessionScopePrefab
...
- See [Plugin README](addons/EasyDI.Godot/README.md)
- EasyDI core framework documentation
- EasyDI.LifecycleHooks documentation
