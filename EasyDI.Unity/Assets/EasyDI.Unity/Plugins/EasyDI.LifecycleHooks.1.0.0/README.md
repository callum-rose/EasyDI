...
EasyDI has been designed to be as portable as possible across different application types. So it doesn't make any assumptions about how your lifecycle hooks will be invoked. Instead, it lets you register your own and provides a way to invoke them wherever you choose.
